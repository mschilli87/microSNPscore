...
class SNP {
  public:
    ...
    *********************************************************************/
    ...
    SNP(SNPID the_ID = "", std::string reference_string = "", std::string alternative_string = "", chromosomeType the_chromosome = "", strandType the_strand = Plus, chromosomePosition the_position = 0);
